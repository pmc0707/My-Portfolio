        ...
        <Row>
          <Col md={8} className="home-about-description">
            ...
            <p className="home-about-body">
              ...
              ⚛️ Expertise in modern <b className="purple">JavaScript libraries</b> and frameworks, including <b className="purple">React.js </b>, to deliver highly interactive and efficient <b className="purple">user experiences</b>.
        ...
        <Row>
          <Col md={12} className="home-about-social">
            ...
            <ul className="home-about-social-links">
              ...
              <li className="social-icons">
                <a
                  href="https://www.linkedin.com/in/pmc0707/"
                  target="_blank"
                  rel="noreferrer"
                  className="icon-colour  home-social-icons"
                >
